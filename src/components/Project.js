    ...
    return (
        <main className="bg-blue-100 min-h-screen p-12">
            <section className="container mx-auto">
                ...
                <h2 className="text-lg text-gray-600 flex justify-center mb-12">Welcome To My Title Page!</h2>
                <section className="grid grid-clos-2 gap-8">
                    ...
                    <article className= " relative rounded-lg shadow-xl bg-white p-16">
                        ...
                        <div className="text-gray-500 text-xs space-x-4">
                            ...
                            <span >
                                <strong className="front-bold">Type:{" "}{project.projectType}</strong>
                            </span>
                            <p className="my-6 text-lg text-gray-700 leading-relaxed">{project.discription}
                            </p>
